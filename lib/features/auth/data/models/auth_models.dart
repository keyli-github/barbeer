class AuthResponse {
  ...
  const AuthResponse({required this.accessToken, required this.refreshToken,
      required this.expiresIn, required this.mustChangePassword});
...
class UserProfile {
  ...
  const UserProfile({required this.id, required this.username, required this.rol,
      required this.nivel, this.sedeId, this.sede, required this.createdAt, required this.permisos});
  ...
  factory UserProfile.fromJson(Map<String, dynamic> j) => UserProfile(
    ...
    sede: j['sede'] as Map<String, dynamic>?,
    createdAt: j['createdAt'] as String? ?? '',
    permisos: (j['permisos'] as List?)?.cast<String>() ?? [],
  );

  Map<String, dynamic> toJson() => {'id':id,'username':username,'rol':rol,'nivel':nivel,
      'sedeId':sedeId,'sede':sede,'createdAt':createdAt,'permisos':permisos};
  ...
  String get sedeName => (sede?['nombre'] as String?) ?? '';
}
...
class ActiveSession {
  ...
  const ActiveSession({required this.id, this.deviceName, this.deviceType, this.ip,
      this.lastUsedAt, this.createdAt, required this.isCurrent});
